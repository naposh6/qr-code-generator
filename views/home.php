...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= rtrim(APP_URL, '/') ?>/assets/logo-qr.png">
...
<script src="<?= rtrim(APP_URL, '/') ?>/js/theme.js" defer></script>
<body>
<div class="container">
    ...
    <nav class="user-nav">
        <div style="display:flex; align-items:center; gap:0;">
            <div class="nav-logo-slot" id="site-logo-slot">
                <img src="<?= rtrim(APP_URL, '/') ?>/assets/logo-qr.png" alt="GenerQR" style="width:28px;height:28px;">
            </div>
            <div class="user-info">
    ...
    <div class="card recent-qrs-card" style="margin-top: 30px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; flex-wrap: wrap; gap: 15px;">
            ...
            <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
                ...
                <a href="<?= BASE_DIR ?>/profile" class="apple-link" style="background: #f5f5f7; color: #1d1d1f; border: 1px solid #d2d2d7; padding: 8px 14px; border-radius: 10px; font-size: 13px; text-decoration: none; font-weight: 500; display: inline-flex; align-items: center; transition: all 0.2s;">Вся історія →</a>
            </div>
        </div>
